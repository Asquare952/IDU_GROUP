  ...
  return (
    <DashboardLayout>
      <div className="p-6 md:p-10 bg-[#FBFBFC] min-h-screen">
        <div className="mb-10">
          <h2 className="text-3xl font-bold text-[#162B4C] mb-1">Inspections</h2>
          <p className="text-slate-400 text-sm">Schedule and manage property inspections</p>
        </div>
        <div className="bg-white rounded-[1.5rem] border border-gray-100 p-6 md:p-10 shadow-sm">
          <div className="flex justify-between items-center mb-10">
            <h3 className="text-lg font-bold text-[#162B4C]">Upcoming Inspections</h3>
              ...
              >
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-1.5 text-slate-400 text-[12px] mb-1">
                    <MapPin size={13} className="text-[#43A047]/60" /> {item.address}
                  </div>
