...
// TEMP: top-up disabled in production while withdrawal is being fixed — still testable locally.
const IS_TOPUP_DISABLED = process.env.NODE_ENV === "production";
...
const page = () => {
  ...
  const handleContinue = () => {
    if (IS_TOPUP_DISABLED) {
      toast.info(
        "Top-up is currently undergoing maintenance. Please check back soon.",
      );
      return;
    }
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6">
            ...
            {isPending && (
              <p className="text-center text-sm text-slate-500 mt-3">
                Redirecting you to Flutterwave, please wait...
              </p>
            )}
          </div>
        </div>
