            ...
            <div className="flex flex-wrap gap-2 mb-5">
              {QUICK_AMOUNTS.map((value) => (
                <button
                  ...
                  className={`px-3.5 py-2 rounded-lg text-sm font-medium border transition-colors cursor-pointer ${Number(amount) === value ? "bg-[#43A047] border-[#43A047] text-white" : "border-slate-200 text-slate-700 hover:border-[#43A047]/40"}`}
                >
