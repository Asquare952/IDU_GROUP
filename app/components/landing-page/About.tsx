    ...
    <div className="bg-[#E8F0E9] py-24 px-4 mb-5">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-[#4CAF50] font-bold text-lg md:text-2xl uppercase tracking-wider">
            How it works
          </span>
          <h2 className="text-3xl md:text-5xl font-bold text-[#1A2B49] mt-4 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full">
            <div className="h-28 md:h-32 flex items-center justify-center mb-6">
              <Image
                ...
                width={90}
                height={90}
                className="w-[72px] md:w-[90px] h-auto"
              />
            </div>
            <div className="mt-auto">
              ...
              <p className="text-[#807979] text-base font-medium leading-relaxed">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full">
            <div className="h-28 md:h-32 flex items-center justify-center mb-6 relative w-full">
              <Image
                src="/map.webp"
                alt="World Map"
                width={180}
                height={100}
                className="absolute w-[140px] md:w-[180px] h-auto opacity-40"
              />
              <Image
                src="/map2.png"
                alt="Location Bubble"
                width={150}
                height={80}
                className="relative z-10 w-[120px] md:w-[150px] h-auto"
              />
            </div>
            <div className="mt-auto">
              <div className="flex items-center gap-2 mb-3">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full">
            <div className="h-28 md:h-32 relative w-full mb-6">
              <Image
                src="/connect image1.png"
                alt="Chat 1"
                width={150}
                height={50}
                className="absolute top-0 left-0 w-[120px] md:w-[150px] h-auto"
              />
              <Image
                ...
                width={120}
                height={40}
                className="absolute bottom-0 right-0 w-[96px] md:w-[120px] h-auto"
              />
            </div>
            <div className="mt-auto">
              <div className="flex items-center gap-2 mb-3">
