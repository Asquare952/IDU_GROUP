      ...
      <div className="bg-white rounded-[32px] p-6 lg:p-10 flex flex-col lg:flex-row items-center gap-14 lg:gap-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start">
          <div className="flex items-center gap-2 mb-4">
            <Image src="/IDU GROUP LOGO.png" alt="RentULO Icon" width={24} height={24} />
            <span className="font-bold text-xl text-[#111827]">Rent<span className="text-green-600">ULO</span></span>
          </div>
          ...
          <p className="mt-6 text-gray-500 font-normal text-lg leading-relaxed max-w-lg">
            ...
            innovation, development, and unity. Our mission: to simplify housing
            for everyone.
          </p>

          <button className="bg-[#22C55E] hover:bg-green-700 text-white font-semibold py-3 px-10 rounded-full transition duration-300 text-base mt-8 cursor-pointer">
            Join our mission
          </button>
        </div>
      </div>
